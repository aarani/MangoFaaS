...
namespace MangoFaaS.Firecracker.API.Models
{
    ...
    #pragma warning restore CS1591
    {
        ...
        public global::MangoFaaS.Firecracker.API.Models.Drive_cache_type? CacheType { get; set; }
...
#nullable restore
        ...
        public global::MangoFaaS.Firecracker.API.Models.Drive_io_engine? IoEngine { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::MangoFaaS.Firecracker.API.Models.RateLimiter? RateLimiter { get; set; }
#nullable restore
#else
        public global::MangoFaaS.Firecracker.API.Models.RateLimiter RateLimiter { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::MangoFaaS.Firecracker.API.Models.Drive"/> and sets the default values.
        /// </summary>
        public Drive()
        {
            AdditionalData = new Dictionary<string, object>();
            CacheType = global::MangoFaaS.Firecracker.API.Models.Drive_cache_type.Unsafe;
            IoEngine = global::MangoFaaS.Firecracker.API.Models.Drive_io_engine.Sync;
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::MangoFaaS.Firecracker.API.Models.Drive"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::MangoFaaS.Firecracker.API.Models.Drive CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::MangoFaaS.Firecracker.API.Models.Drive();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "cache_type", n => { CacheType = n.GetEnumValue<global::MangoFaaS.Firecracker.API.Models.Drive_cache_type>(); } },
                { "drive_id", n => { DriveId = n.GetStringValue(); } },
                { "io_engine", n => { IoEngine = n.GetEnumValue<global::MangoFaaS.Firecracker.API.Models.Drive_io_engine>(); } },
                ...
                { "rate_limiter", n => { RateLimiter = n.GetObjectValue<global::MangoFaaS.Firecracker.API.Models.RateLimiter>(global::MangoFaaS.Firecracker.API.Models.RateLimiter.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::MangoFaaS.Firecracker.API.Models.Drive_cache_type>("cache_type", CacheType);
            writer.WriteStringValue("drive_id", DriveId);
            writer.WriteEnumValue<global::MangoFaaS.Firecracker.API.Models.Drive_io_engine>("io_engine", IoEngine);
            ...
            writer.WriteObjectValue<global::MangoFaaS.Firecracker.API.Models.RateLimiter>("rate_limiter", RateLimiter);
