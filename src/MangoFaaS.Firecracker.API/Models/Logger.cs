...
namespace MangoFaaS.Firecracker.API.Models
{
    ...
    public partial class Logger : IAdditionalDataHolder, IParsable
    {
        ...
        public global::MangoFaaS.Firecracker.API.Models.Logger_level? Level { get; set; }
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::MangoFaaS.Firecracker.API.Models.Logger"/> and sets the default values.
        /// </summary>
        public Logger()
        {
            AdditionalData = new Dictionary<string, object>();
            Level = global::MangoFaaS.Firecracker.API.Models.Logger_level.Info;
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::MangoFaaS.Firecracker.API.Models.Logger"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::MangoFaaS.Firecracker.API.Models.Logger CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::MangoFaaS.Firecracker.API.Models.Logger();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "level", n => { Level = n.GetEnumValue<global::MangoFaaS.Firecracker.API.Models.Logger_level>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::MangoFaaS.Firecracker.API.Models.Logger_level>("level", Level);
